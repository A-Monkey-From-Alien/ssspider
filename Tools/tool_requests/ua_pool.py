...
class UA(object):
    ...
    def __init__(self):
        self.PCUA_LIST = [
            ...
            "Opera/9.20 (Macintosh; Intel Mac OS X; U; en)", "Opera/9.64 (Macintosh; PPC Mac OS X; U; en) Presto/2.1.1",
            ...
            "Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 5.0 )", "Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 5.0)",
            ...
            "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; Trident/5.0)", "Opera/9.25 (Windows NT 6.0; U; en)",
        ...
        self.PHONEUA_LIST = [
            ...
            'SamsungI8910/SymbianOS/9.1 Series60/3.0 ', 'NokiaN97i/SymbianOS/9.1 Series60/3.0 ',
            'NokiaE52-1/SymbianOS/9.1 Series60/3.0 3gpp-gba ', 'NokiaE5-00/SymbianOS/9.1 Series60/3.0 3gpp-gba ',
    ...
    def pc_ua(self):
        """随机选择一个电脑版的ua"""
        pc = random.choice(self.PCUA_LIST)
        return pc

    def phone_ua(self):
        """随机选择一个手机版的ua"""
        ph = random.choice(self.PHONEUA_LIST)
        return ph
